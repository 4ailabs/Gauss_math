      ...
      <div className="space-y-3 sm:space-y-4">
        <div className="relative">
          <textarea
            ...
            className="w-full h-32 sm:h-40 md:h-48 p-3 sm:p-4 border border-slate-300 rounded-xl resize-none focus:ring-2 focus:ring-teal-600 focus:border-teal-600 focus:outline-none text-slate-900 placeholder-slate-500 text-base sm:text-base"
            disabled={isLoading}
          />
